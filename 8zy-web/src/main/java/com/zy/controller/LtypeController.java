...
import com.zy.entity.Ltype;
import com.zy.service.ILtypeService;
...
public class LtypeController extends BaseController {
    ...
    public String queryCondition(@RequestBody BootStrapParams bspage, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            Page<Ltype> pages = new Page<>(bspage.getPage(), bspage.getRows());
            IPage<Ltype> result = this.iLtypeService.page(pages, queryWrapper);
    ...
    @ResponseBody
    public String addContact(@RequestBody Ltype ltype, HttpServletRequest request, HttpServletResponse response) {
        try {
    ...
    @ResponseBody
    public String edit(@RequestBody Ltype ltype, HttpServletRequest request, HttpServletResponse response) {
        try {
            System.out.println(ltype);
            if (iLtypeService.updateById(ltype)) {
                return "success";
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String delete(@RequestBody BootStrapParams bspage, HttpServletRequest request) {
        try {
            ...
            if (StringUtils.isNotBlank(ids)) {
                ...
                if (list != null) {
                    for (String id : list) {
                        this.iLtypeService.removeById(id);
                    }
                    return "success";
                }
            }
