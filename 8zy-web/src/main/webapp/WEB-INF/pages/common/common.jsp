...
<head>
    ...
    <script src="${pageContext.request.contextPath }/plugins/jquery.serializejson.min.js"></script>
	<!--bootstrap-->
    ...
    <script>
        function dfYmdhms(dateVal) {
            if (dateVal != null) {
                return dateVal.year + "-" + dateVal.monthValue + "-" + dateVal.dayOfMonth + " " + dateVal.hour + ":" + dateVal.minute + ":" + dateVal.second;
            }
        }
        function dfYmd(dateVal) {
            if (dateVal != null) {
                return dateVal.year + "-" + dateVal.monthValue + "-" + dateVal.dayOfMonth;
            }
        }
